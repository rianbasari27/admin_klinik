				...
				<form action="" method="post">
					<table>
						...
						<tr>
							...
							<td>:</td>
							<td><input type="text" class="form-control" id="keluhan" name="keluhan" value='<?= $berobat['keluhan']; ?>' required></td>
						</tr>
						<tr>
							<td><label for="biaya_admin">Biaya Administrasi</label></td>
							<td>:</td>
							<td><input type="number" class="form-control" name="biaya_admin" id="biaya_admin" value='<?= $berobat['biaya_admin']; ?>' required></td>
						</tr>
					</table>
					<br>
