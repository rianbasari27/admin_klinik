...
$list_berobat = query(
    ...
    ORDER BY berobat.no_transaksi DESC'
);
                ...
                <table class='table table-striped'>
                    ...
                    <?php foreach ($list_berobat as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href='update.php?status=edit&no_transaksi=<?= $row['no_transaksi']; ?>' class='btn btn-success btn-sm'>Edit</a>
                                <a href='delete.php?no_transaksi=<?= $row['no_transaksi']; ?>' class='btn btn-danger btn-sm' onclick="return confirm('Anda yakin ingin menghapus data ini?');">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
