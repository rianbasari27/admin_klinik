				...
				<form action="" method="post">
					<table>
						<tr>
							...
							<td>:</td>
							<td colspan=3><input type="text" class="form-control" name="no_transaksi" id="no_transaksi" required></td>
						</tr>
						<tr>
							...
							<td>
								<table>
									<tr>
										...
										<td><input type="number" class="form-control" name="tahun" required></td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<tr>
							...
							<td>:</td>
							<td><input type="text" class="form-control" name="keluhan" id="keluhan" required></td>
						</tr>
						<tr>
							<td><label for="biaya_admin">Biaya Administrasi</label></td>
							<td>:</td>
							<td><input type="number" class="form-control" name="biaya_admin" id="biaya_admin" required></td>
						</tr>
					</table>
					<br>
